...
class AppiariesPush extends AbstractType
{
    /** @private */ private $app;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder
            ...
            ->add('push_reserve_title', 'text', array(
                'label'       => '配信予約タイトル',
                'required'    => true,
                'constraints' => array(
                    new Assert\NotBlank(array(
                        'groups' => array('message','message_ios','message_android'))
                    ),
                    new Assert\Length(
                        array(
                            'max' => 32,
                            'groups' => array('message','message_ios','message_android','edit')
                        )
                    )
                ),
            ))
            ...
            ->add('badge', 'text', array(
                ...
                'constraints' => array(
                    new Assert\Type(
                        array(
                            'type' => 'numeric',
                            'groups' => array('message','message_ios','edit')
                        )
                    ),
            ...
            ->add('title', 'text', array(
                ...
                'constraints' => array(
                    new Assert\NotBlank(array(
                        'groups' => array('message','message_android'))
                    ),
                    new Assert\Length(
                        array(
                            'max' => 32,
                            'groups' => array('message','message_android','edit')
                        )
                    )
                ),
            ))
            ...
            ->add('delivery_date', 'datetime', array(
                ...
                'constraints' => array(
                   new Assert\NotBlank(array('groups' => array('reserve','edit'))),
                ),
            ))
